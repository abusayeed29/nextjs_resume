...
const DownloadButton = () => {
    ...
    return (
        <>
            <div className="mt-5 mx-3 lg:mx-0 text-gray-500 bg-white px-5 py-2 shadow-md rounded-full font-sm my-3 hover:shadow-xl active:scale-90 transition duration-150 hover:bg-red-500 hover:text-white  lg:w-3/12 hover:cursor-pointer">
