    ...
    return (
        <div className="flex flex-col lg:flex-row space-x-3 overflow-scroll scrollbar-hide p-6 justify-between">
            <div className="w-2/5">
                ...
                <div>
                    <a href="tel:01632 960192" className="flex items-center my-2 inline-flex"> 
                    ...
                    <a href="mailto:2321 Wildwood Street, OH, 44503" className="flex items-center my-2">
                        <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path></svg>
                        abusayeed29@gmail.com
                    </a>
                    <div className="flex items-center my-2 inline-flex">
                        <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                        MON-SAT, 9-5 | SUN, 10-4
                    </div>
                    <a href="https://goo.gl/maps/vpgZzbcv6wVwu9sH9" target="_blank" className="flex items-center my-2 inline-flex">
            ...
            <div className="lg:w-3/5">
                ...
                {data ? (
                    <div class="border border-green-100 bg-green-200 text-green-900 p-3 mb-5 rounded-md flex flex-inline justify-between">
                        <p>{data}</p> <span className="text-white hover:text-red-400 hover:cursor-pointer w-6 text-center">x</span>
                    </div>
                ): ''}
                ...
                <form className="w-full" onSubmit={handleSubmit(onSubmitForm)}>
                    ...
                    <div className="flex flex-wrap -mx-3 mb-6">
                        <div className="w-full px-3">
                            ...
                            <textarea className="no-resize appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500 h-36 resize-none"
